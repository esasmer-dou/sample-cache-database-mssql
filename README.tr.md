...
Yani kullanıcı ana projeyi önce build etmek zorunda değildir. Maven, GitHub Packages için erişim isterse `~/.m2/settings.xml` içine okuma yetkili token eklenmelidir.

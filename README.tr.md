...
Geçiş sürecindeki kritik parça burasıdır. Servis SQL Server’dan okur, sonra
...
`POST /api/orders` da müşteri satırı SQL Server tarafında kalıcı hale gelene kadar kısa süre bekler. Müşteri az önce oluşturulduysa ve write-behind henüz SQL Server’a yazmadıysa çağrı `409` döner; istemci kısa süre sonra tekrar denemelidir.

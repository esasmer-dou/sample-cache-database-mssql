...
`registerJdbcBacked(...)` is what lets CacheDB read a bounded query from SQL Server when you intentionally warm or read through:
...
This is the critical migration path. It reads SQL Server, then hydrates Redis
